...
export default function CareersPageClient() {
    ...
    const jsonLd = {
        ...
        hiringOrganization: {
            '@type': 'Organization',
            name: 'CodeFixerz',
            sameAs: 'https://www.codefixerz.com',
        ...
        description: 'Join the CodeFixerz team. We are hiring Frontend Developers, Backend Developers, UI/UX Designers, and Digital Marketing Specialists.',
        ...
        breadcrumb: {
            ...
            itemListElement: [
                ...
                },
                {
                    ...
                    position: 2,
                    name: 'Careers',
                    item: 'https://www.codefixerz.com/careers'
                }
            ]
        }
    };
