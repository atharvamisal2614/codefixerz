...
export default function ContactPageClient() {
    const jsonLd = {
        ...
        '@type': 'ContactPage',
        name: 'Contact CodeFixerz',
        description: 'Get in touch with CodeFixerz for web development, software solutions, and digital marketing services.',
        ...
        breadcrumb: {
            ...
            itemListElement: [
                ...
                },
                {
                    ...
                    position: 2,
                    name: 'Contact',
                    item: 'https://www.codefixerz.com/contact'
                }
            ]
        }
    };
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:webagency2614@gmail.com" className="text-[var(--text)]">enquiry@codefixerz.com</a><br />
                                        </div>
                                    </div>
