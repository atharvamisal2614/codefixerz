...
export default function AboutPage() {
  return (
    <>
      <div className="pt-28 sm:pt-36 pb-12 sm:pb-20 bg-[#0B1736] text-center relative overflow-hidden">
        {/* Background glow */}
        ...
        <div className="relative z-10 px-5">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight">About Us</h1>
          <p className="text-blue-100/70 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
